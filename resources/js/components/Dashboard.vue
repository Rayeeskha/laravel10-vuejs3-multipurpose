    ...
    <div class="row">
      <div class="col-lg-3 col-sm-6 col-12">
         <div class="dash-widget">
            <div class="dash-widgetimg">
               <span><img :src="url+'img/icons/dash1.svg'" alt="img"></span>
            </div>
      ...
      <div class="col-lg-3 col-sm-6 col-12">
         <div class="dash-widget dash1">
            <div class="dash-widgetimg">
               <span><img :src="url+'img/icons/dash2.svg'" alt="img"></span>
            </div>
            <div class="dash-widgetcontent">
      ...
      <div class="col-lg-3 col-sm-6 col-12">
         <div class="dash-widget dash2">
            <div class="dash-widgetimg">
               <span><img :src="url+'img/icons/dash3.svg'" alt="img"></span>
            </div>
            <div class="dash-widgetcontent">
      ...
      <div class="col-lg-3 col-sm-6 col-12">
         <div class="dash-widget dash3">
            <div class="dash-widgetimg">
               <span><img :src="url +'img/icons/dash4.svg'" alt="img"></span>
            </div>
            <div class="dash-widgetcontent">
